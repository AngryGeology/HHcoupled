...
sim_dir = os.path.join(model_dir,'Synth')
datadir = os.path.join(synth_dir,'Data')
for d in [synth_dir,model_dir,sim_dir,datadir]:
...
h.writeInp(maximise_io=False) # write input without water table at base of column
...
setupfig = h.showSetup(save=False,custom_flags=node_flags, return_fig=True)  
